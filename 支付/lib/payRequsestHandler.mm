...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPay_demo:(NSDictionary *)tmpDic
{
    ...
    //描述
    NSString *bodyStr = [NSString stringWithFormat:@"%@", tmpDic[@"body"]];
    //价钱
    NSString *total_feeStr = [NSString stringWithFormat:@"%@", tmpDic[@"total_fee"]];
    //订单号(即为商户订单号)
    NSString *out_trade_noStr = [NSString stringWithFormat:@"%@", tmpDic[@"order_sn"]];
    //回调通知
    NSString *NoticeUrlStr = [NSString stringWithFormat:@"%@", tmpDic[@"notify_url"]];
    ...
    //NSString *orderno = [NSString stringWithFormat:@"%ld",time(0)];//一般不是随机数，是自己的订单号order_sn
    ...
    [packageParams setObject: bodyStr           forKey:@"body"];        //订单描述，展示给用户
    //  [packageParams setObject: NOTIFY_URL        forKey:@"notify_url"];  //支付结果异步通知
    [packageParams setObject: NoticeUrlStr      forKey:@"notify_url"];  //支付结果异步通知
    //  [packageParams setObject: orderno           forKey:@"out_trade_no"];//商户订单号
    [packageParams setObject: out_trade_noStr   forKey:@"out_trade_no"];//商户订单号
    ...
    [packageParams setObject: total_feeStr      forKey:@"total_fee"];       //订单金额，单位为分
